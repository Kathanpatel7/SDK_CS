...
rb = RobotData()
rb.connect('192.168.139.129') #ip of robot
sample_count = 1
# below command "movej"is for movement, please check the script manual of CS
while sample_count >= 0:
    mes = "def mov():\r\n    movej([1.57000,-1.01469,-2.04816,-1.79723,1.5708,-0],a=1.4,v=1.05,t=0,r=0)\r\nend\r\n"
    rb.send_data(mes.encode())
    time.sleep(0.1)
    sample_count -= 1
